...
public class ProductsController(IMediator mediator) : ApiControllerBase
{
    ...
    public async Task<ActionResult<PaginatedResponse<ProductDto>>> GetProducts([FromQuery] int page = 1, [FromQuery] int pageSize = 20, CancellationToken cancellationToken = default) =>
